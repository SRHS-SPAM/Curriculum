  ...
  return (
    <div className="flex items-center justify-between w-full h-[80px] bg-gray-800 p-4 select-none">
      ...
      <div className="flex space-x-4">
        <Button
          className={cn(lectureNow === 1 && "opacity-50")}
          size={"icon"}
          asChild
        >
        ...
        <div className="h-full text-2xl whitespace-nowrap font-bold flex items-center">
          {lectureNow} / {lectureQuantity}
        </div>
        <Button
          className={cn(lectureNow === lectureQuantity && "opacity-50")}
          size={"icon"}
          asChild
        >
          <Link
            href={lectureNow === lectureQuantity ? "#" : `${lectureNow + 1}`}
          >
            <ArrowRight />
          </Link>
        </Button>
